...
-2 \frac{\psi^n}{\eta^\star-\eta^{n-1/2}} & if $\eta^{n+1/2} < 0$ \label{eq:collCorr}
\end{subnumcases}
...
Finally, boundary condition \eqref{eq:discNeumann} can be modified to Eq. \eqref{eq:UbUr}, effectively coupling the lip reed to the tube. 
